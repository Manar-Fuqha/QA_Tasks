...
describe('Check Add To WishList Functionality', () => {
    ...
    it('validate that the user can add the product to the wishlist from product page' , ()=>{
        ...
        cy.get("[title='Go to Wish List']").should("be.visible").and("contain" , "Go to Wish List")
